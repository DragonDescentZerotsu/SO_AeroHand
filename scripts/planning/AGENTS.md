...
当前 handoff 场景里的桌面、rack、Aero Hand 和部分 pipette visual 在 Blender 中仍偏白，这是可视化材质 polish，不阻塞轨迹生成。最终 pipetting 视频/训练集导出前再统一设置非液体物体材质、透明 tip visual 和 tip close camera；否则不适合用来人工判断 tip 内液面。
