...
teleop.DEFAULT_IK_MODE = "osqp_full_pose"
teleop.DEFAULT_ROBOT_GRAVITY_ROOT = "base_link"
teleop.DEFAULT_INITIAL_ARM_QPOS = "0 1.57 -1.3485 0 0 0"
...
teleop.DEFAULT_QP_ADAPTIVE_ORIENTATION = True
teleop.DEFAULT_QP_ORIENTATION_SINGULARITY_THRESHOLD = 0.05
teleop.DEFAULT_QP_ORIENTATION_JOINT_LIMIT_MARGIN = 0.20
teleop.DEFAULT_QP_MINIMUM_ORIENTATION_SCALE = 0.08
teleop.DEFAULT_QP_ADAPTIVE_POSITION_BOOST = 25.0
